...
const HeroSection = () => {
  return (
    <div className="relative h-screen bg-black">
      ...
      {/* Header Content */}
      <div className="relative z-10 flex flex-col items-center lg:items-start justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 text-white h-screen font-Dubai sm:mb-20 lg:mb-24 lg:pt-28">
